...
namespace BioEngine.BRC.Core.Db.Migrations
{
    ...
    [Migration("20190401112159_drop_description_from_sections_use_blocks_instead")]
    partial class drop_description_from_sections_use_blocks_instead
    {
            ...
            modelBuilder.Entity("BioEngine.Core.Entities.Blocks.IframeBlock", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("BioEngine.Core.Entities.Blocks.IframeBlock");
                });
