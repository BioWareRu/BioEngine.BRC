...
namespace BioEngine.BRC.Core.Comments
{
    public abstract class BaseCommentsProvider : ICommentsProvider
    {
        ...
        public virtual async Task<IEnumerable<BaseComment>> GetLastCommentsAsync<TContent>(Site site,
        ...
        public abstract Task<BaseComment> AddCommentAsync(IContentItem entity, string text, string authorId,
            Guid? replyTo = null);

        public abstract Task<BaseComment> UpdateCommentAsync(IContentItem entity, Guid commentId, string text);

        public async Task<BaseComment> DeleteCommentAsync(IContentItem entity, Guid commentId)
        {
        ...
        public async Task<IEnumerable<BaseComment>> GetCommentsAsync(IContentItem entity, Site site)
        {
        ...
        public async Task<BaseComment> GetCommentByIdAsync(IContentItem entity, Guid commentId)
        {
