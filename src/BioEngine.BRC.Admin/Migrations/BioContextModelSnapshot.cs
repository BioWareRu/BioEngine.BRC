...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Ad", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.ContentBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Page", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.PostTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.PostVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.PropertiesRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Section", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Site", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.StorageItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.CutBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.FileBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.GalleryBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.IframeBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.PictureBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.QuoteBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.TextBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.TwitchBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.TwitterBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Blocks.YoutubeBlock", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.ContentBlock");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Developer", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.Section");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Game", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.Section");
            ...
            modelBuilder.Entity("BioEngine.BRC.Core.Entities.Topic", b =>
                {
                    b.HasBaseType("BioEngine.BRC.Core.Entities.Section");
